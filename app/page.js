            ...
            <Container className='mt-9'>
                <div className='max-w-2xl'>
                    ...
                    <p className='mt-6 text-base text-zinc-600 dark:text-zinc-400'>
                        Combino estrategia empresarial y herramientas de IA avanzadas para crear soluciones web
                        excepcionales en tiempo récord. Mi metodología revolucionaria reduce los tiempos de desarrollo
                        hasta un 70% sin comprometer la calidad ni la innovación.
                    </p>
